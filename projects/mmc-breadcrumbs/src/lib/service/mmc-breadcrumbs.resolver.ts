...
import {IBreadcrumb, stringFormat} from '../mmc-breadcrumbs.shared';
import {Observable, of} from 'rxjs';

export class MmcBreadcrumbsResolver implements Resolve<IBreadcrumb[]> {
  public resolve(route: ActivatedRouteSnapshot,
                 state: RouterStateSnapshot): Observable<IBreadcrumb[]> | Promise<IBreadcrumb[]> | IBreadcrumb[] {
